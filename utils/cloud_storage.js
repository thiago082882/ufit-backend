...
const storage = new Storage({
    projectId: "ufit-43403",
    keyFilename: './serviceAccountKey.json'
});

const bucket = storage.bucket("gs://ufit-43403.appspot.com/");
        ...
        if (deletePathImage) {
            ...
            if (deletePathImage != null || deletePathImage != undefined) {
                ...
                fileDelete.delete().then((imageDelete) => {
                    ...
                    console.log('Imagem salva com exito.')
                }).catch(err => {
        ...
        if (pathImage) {
            if (pathImage != null || pathImage != undefined) {
                ...
                blobStream.on('error', (error) => {
                    console.log('Erro ao enviar a imagem para o firebase', error);
